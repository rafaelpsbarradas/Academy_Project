        ...
        <form action="insertpost" method="post">
            <table border="1" cellpadding="5">
                ...
                <tr>
                    <th>Title:</th>
                    <td>
                        <input type="text" name="title" size="" required="true" value="<c:out value='${post.title}' />" />
                    </td>
                </tr>
                <tr>
                    <th>BookId:</th>
                    <td>
                        <input type="number" name="bookid" size="13" required="true" value="<c:out value='${book.id}' />" />
                    </td>
                </tr>
                <tr>
                    <th>Description:</th>
                    <td>
                        <input type="text" name="description" size="" value="<c:out value='${post.description}' />" />
                    </td>
                </tr>
                <tr>
